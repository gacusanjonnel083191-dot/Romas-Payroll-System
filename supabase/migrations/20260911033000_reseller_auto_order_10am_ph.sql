...
-- This migration only changes the automatic-order schedule, automatic template/skip locks,
...
-- This also remains compatible with installations where the recurring-weekly-skip helper
-- has not yet been installed: only functions that exist are patched.

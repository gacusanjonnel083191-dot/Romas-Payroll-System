...
async function reset(){
  await db.exec(`reset role; truncate private.ca_payroll_allocations,private.ca_payroll_batches,private.ca_integrity_events,public.cash_advances,public.payroll_records,public.payroll_periods,public.daily_expenses,public.time_adjustment_requests,public.audit_logs,public.admin_users;

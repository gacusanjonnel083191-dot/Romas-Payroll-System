...
// Keep sign-off directly below the table instead of at the physical bottom edge.
...
// Narrow and center the production table so Variant and Pieces are visually closer together.
...
// Use more of the page vertically, improve legibility, and keep clear ruled cells.
...
// Make the overall title/summary block proportionate to the larger portrait page.
